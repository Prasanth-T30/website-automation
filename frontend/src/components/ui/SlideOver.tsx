 ...
 */
export function SlideOver({ open, onOpenChange, title, description, children, className }: SlideOverProps) {
  return (
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        <RadixDialog.Overlay
          className={cn(
            "fixed inset-0 z-50 bg-slate-950/40 transition-opacity duration-200",
