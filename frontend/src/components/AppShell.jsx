  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {urgentCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-[17px] min-w-[17px] items-center justify-center rounded-full bg-danger px-1 text-[9.5px] font-bold text-white ring-2 ring-chrome">
            {urgentCount}
          </span>
        )}
      </button>
  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-2.5 rounded-md py-1 pr-2 pl-1 transition-colors hover:bg-white/[0.07]"
      >
        <span className="flex size-[30px] items-center justify-center rounded-[10px] bg-gradient-to-br from-brand to-accent text-[11px] font-bold text-white">
