...
const PASSED_OUT_YEARS = passedOutYearChoices();
      ...
      {step === 1 && (
        <section className="dv-section">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Input label="Native" required placeholder="Home town / district" error={errors.native_place?.message} {...register("native_place", { required: "Native is required" })} />
            ...
            <Input
              ...
              required
              error={errors.passed_out_year?.message}
              {...register("passed_out_year", { required: "Year of passing out is required" })}
            >
              <option value="">Select year</option>
